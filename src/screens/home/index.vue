...
<script>
  ...
  import { RefreshControl, Platform , Dimensions, Linking, AppState, Text } from 'react-native'
    ...
    methods: {
      ...
      fetchTopApi() {
        this.axios.get('/api/top').then(({data: res}) => {
          ...
          console.log(res.data.popups, "res.data.popup123")
          // const datax = [
          //   {
          //       click_numbers:0,
          //       created_at:"2021-12-05T23:53:24.000+09:00",
          //       id:84,
          //       img_url:{
          //         url:"https://scontent-sin6-1.xx.fbcdn.net/v/t39.30808-6/268636885_441819320716494_8970759298336758082_n.jpg?_nc_cat=1&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=qYO3HZeJIrEAX9MWSao&_nc_ht=scontent-sin6-1.xx&oh=00_AT_QyRcVWXBtRMBirY6ToDdjikee-1fASb7JfoUysobU1w&oe=61C4B14B"
          //       },
          //       jump_to:"https://bongdaplus.vn/",
          //       popup_type:"external_url",
          //       start_publish_at:"2021-12-05T00:00:00.000+09:00",
          //       stop_publish_at:"2021-12-07T00:00:00.000+09:00",
          //       updated_at:"2021-12-05T23:53:24.000+09:00"
          //   },
          //   {
          //       click_numbers:0,
          //       created_at:"2021-12-05T23:53:24.000+09:00",
          //       id:84,
          //       img_url:{
          //         url:"https://scontent-sin6-4.xx.fbcdn.net/v/t39.30808-6/269587832_4896698190446597_1647116425097449544_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=730e14&_nc_ohc=6mQjTZER3GYAX8CXAbG&_nc_ht=scontent-sin6-4.xx&oh=00_AT_vL6gom3Nny7gQ5umNS_0GwgJtwLiVJzMgNE1yKhNAtg&oe=61C3B0D5"
          //       },
          //       jump_to:"334",
          //       popup_type:"internal_url",
          //       start_publish_at:"2021-12-05T00:00:00.000+09:00",
          //       stop_publish_at:"2021-12-07T00:00:00.000+09:00",Data nay
          //       updated_at:"2021-12-05T23:53:24.000+09:00"
          //   }
          // ]
          //   this.showPopupModal(datax)
          if (res.data.popups&&res.data.popups.length>0) {
            this.showPopupModal(res.data.popups)
          }
      ...
      showPopupModal(data){
        this.$refs.popupModal.setPopupData(data);
      },
