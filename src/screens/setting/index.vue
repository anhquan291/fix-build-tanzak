...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      is_scroll_mode: 'user/is_scroll_mode',
  ...
  watch: {
    ...
    is_scroll_mode (newVal, oldVal){
      console.log(newVal, "watch new value is scroll mode")
      this.scrollMode = newVal;
      this.is_scroll_mode = newVal
    }
  },
  methods: {
    ...mapMutations({
    ...
    ...mapActions({
      ...
      update_is_scroll_mode: 'user/update_is_scroll_mode',
